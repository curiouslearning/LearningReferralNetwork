...
class Application(Model):
    ...
    def __init__(self, description: str=None, locale: str=None, platform_id: str=None, title: str=None, icon_url: str=None, skills: List[str]=None):  # noqa: E501
    ...
    def icon_url(self) -> str:
        ...
        URL path of the application icon image  # noqa: E501
